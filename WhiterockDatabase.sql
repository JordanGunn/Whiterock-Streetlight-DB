...
(
    POLE_ID 			INTEGER,
    POLE_NEAR_BUSSTOP 		BIT			NOT NULL,
    POLE_NEAR_SCHOOL 		BIT			NOT NULL,
    POLE_NEAR_PARK 			BIT			NOT NULL,
    POLE_NEAR_SIDEWALK 		BIT			NOT NULL,
    POLE_IS_TRAFFIC			BIT			NOT NULL,
    POLE_IS_LIGHT			BIT			NOT NULL,
...
INSERT INTO EMPLOYEE (EMPLOYEE_FNAME, EMPLOYEE_LNAME) VALUES
('John', 		'Doe'), 
('Sean', 		'Yue'), 
('Ryan', 		'Odribege'),
('Jan', 		'Doe'),
...
INSERT INTO POLE 
(
	POLE_ID, POLE_NEAR_BUSSTOP, POLE_NEAR_SCHOOL, POLE_NEAR_PARK, 
	POLE_NEAR_SIDEWALK, POLE_IS_TRAFFIC, POLE_IS_LIGHT, POLE_ESTIMATED_AGE,
	POLE_STYLE, POLE_BASE, POLE_HGT, POLE_LAT, POLE_LONG
) 
VALUES
(1,		1,	1,	1,	1,	1,	1, 25,	'HPS Domus',		'Y',	6,		49.02922429,	-122.8010562),
(2,		0,	0,	0,	0,	1,	1, 35,	'HPS Domus',		'Y',	6,		49.0294399,		-122.8010201),
(3,		1,	1,	1,	1,	1,	0, 5,	'LED Cobra Head',	'N',	4,		49.02589485,	-122.8013455),
(4,		0,	1,	1,	1,	1,	0, 25,	'HPS Cobra Head',	'N',	6,		49.0257423,		-122.8010596),
(5,		0,	1,	0,	1,	1,	0, 10,	'HPS Cobra Head',	'N',	4,		49.0256355,		-122.8011562),
(6,		0,	0,	0,	0,	1,	1, 25,	'HPS Cobra Head',	'Y',	6,		49.02567313,	-122.8011125),
(7,		1,	1,	1,	0,	1,	1, 40,	'HPS Cobra Head',	'Y',	9.5,	49.0275548,		-122.8095381),
(8,		1,	0,	1,	1,	0,	1, 20,	'LED Domus',		'Y',	7.5,	49.02783973,	-122.8093333),
(9,		1,	1,	1,	1,	0,	1, 15,	'LED Domus',		'Y',	7.5,	49.02895828,	-122.8092151),
(10,	1,	0,	0,	0,	0,	1, 25,	'LED Domus',		'Y',	7.5,	49.02761232,	-122.805421)
...
INSERT INTO MAINT_RECORD(MAINT_ID, POLE_ID, EMPLOYEE_ID, MAINT_RECORD_DATE, MAINT_TYPE) 
VALUES
(1, 	1, 	1, 	'2001-01-01 00:00:00', 'S'),       
(2, 	2, 	2, 	'2001-01-02 00:00:00', 'S'),
(3,		3, 	3, 	'2001-01-03 00:00:00', 'S'),
(4, 	4, 	4, 	'2001-01-04 00:00:00', 'S'),
(5, 	5, 	5, 	'2001-01-05 00:00:00', 'S'),
(6, 	6, 	1, 	'2001-01-10 00:00:00', 'S'),
(7, 	7, 	2, 	'2019-01-11 00:00:00', 'S'),
(8, 	5, 	3, 	'2001-02-05 00:00:00', 'S'),
(9, 	1, 	4, 	'2001-02-05 00:00:00', 'S'),
(10, 	2, 	5, 	'2001-02-06 00:00:00', 'S'),
(11, 	3, 	1, 	'2019-02-04 00:00:00', 'A'),
(12, 	4, 	2, 	'2001-02-08 00:00:00', 'A'),
(13, 	8, 	6, 	'2001-03-01 00:00:00', 'A'),
(14, 	9, 	7, 	'2003-03-02 00:00:00', 'A'),
(15, 	10, 8, 	'2004-06-01 00:00:00', 'A'), 
(16, 	4, 	9, 	'2010-11-12 00:00:00', 'A'),
(17, 	6, 	10, '2020-01-02 00:00:00', 'A');

GO

INSERT INTO MAINT_CONDITION (MAINT_ID, MAINT_HAMMER_TEST_RESULT, MAINT_VISUAL_RUST, 
	MAINT_LUMINAIRE_COND, MAINT_ANCHOR_BOLTS_COND, MAINT_PANEL_COND) VALUES
(1	,39	,	'Y'	,	2,	'GOOD',	1),
(2	,39	,	'Y'	,	2,	'POOR',	2),
(3	,38	,	'Y'	,	1,	'FAIR',	3),
(4	,41	,	'Y'	,	2,	'BAD',	1),
